					...
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link"
							href="${GetUsrMgmtAdminPage}"> <svg
									...
									<path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> Users
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${GetHotelsMgmtAdminPage}"><svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
									...
									<polyline points="2 12 12 17 22 12"></polyline></svg> Hotels </a></li>
					</ul>
				</div>
			</nav>
					...
					<table class="table table-striped table-sm">
						...
						<tbody>
							<c:forEach var="hotel" items="${hotels}">
								...
								<c:url var="EditHotelLink" value="admin">
									<c:param name="command" value="EDIT_HOTEL" />
									<c:param name="hotelId" value="${hotel.id}" />
									<!-- embedded ID -->
								</c:url>
								<c:url var="DeleteHotelLink" value="AdminServlet">
									<c:param name="command" value="DELETE_HOTEL" />
									<c:param name="hotelId" value="${hotel.id}" />
									<!-- embedded ID -->
								</c:url>
								<tr>
									...
									<td><c:out value="${hotel.numStars}" /></td>
									<td><a href="${EditHotelLink}">Edit</a> | <a
										href="${DeleteHotelLink}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
